...
# Form implementation generated from reading ui file 'didyoureadme/ui/frmHelp.ui'
#
...
class Ui_frmHelp(object):
    ...
    def retranslateUi(self, frmHelp):
        ...
        frmHelp.setWindowTitle(_translate("frmHelp", "DidYouReadMe help"))
        self.lblApp.setText(_translate("frmHelp", "DidYouReadMe help"))
